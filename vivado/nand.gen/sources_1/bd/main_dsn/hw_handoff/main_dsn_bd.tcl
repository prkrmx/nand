...
################################################################
# This is a generated script based on design: main_dsn
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set GPIO_LED_CENTER [ create_bd_port -dir O -from 0 -to 0 GPIO_LED_CENTER ]
  set GPIO_SW_LEFT [ create_bd_port -dir I GPIO_SW_LEFT ]
  set GPIO_SW_RIGHT [ create_bd_port -dir I GPIO_SW_RIGHT ]
...
0#SD 0#SD 0#I2C Reset#ENET Reset#UART 1#UART 1#I2C 0#I2C 0#Enet 0#Enet 0}\
  ...
  connect_bd_net -net a_0_1 [get_bd_ports GPIO_SW_RIGHT] [get_bd_pins AND_gate_0/a]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports GPIO_LED_CENTER] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_0_1 [get_bd_ports GPIO_SW_LEFT] [get_bd_pins AND_gate_0/b]
